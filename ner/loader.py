...
from ner.albert_zh import tokenization
from ner.utils import convert_single_example
from ner.data_utils import create_dico, create_mapping, zero_digits
from ner.data_utils import iob2, iob_iobes

project_dir = os.path.dirname(os.path.abspath(__file__))

tokenizer = tokenization.FullTokenizer(vocab_file='%s/albert_tiny/vocab.txt' % project_dir, do_lower_case=True)
